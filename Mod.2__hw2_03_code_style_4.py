...
# PEP8 (Python Enhancement Proposal 8) - описан
# "правильный" стиль программирования в пайтон
...
# автоматическое переименование в PyCharm и подсказки -
# вам не нужно набирать длинные названия переменных
